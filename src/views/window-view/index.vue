...
export default {
  ...
  methods: {
    ...
    drag (ev) {
      ...
      console.log(ev.target.style.width || ev.target.clientWidth || ev.target.offsetWidth || ev.target.scrollWidth);
      this.width = ev.target.style.width || ev.target.clientWidth || ev.target.offsetWidth || ev.target.scrollWidth;
    },
    drop (ev) {
      console.log(ev)
      ev.preventDefault();
